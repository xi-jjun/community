...
public class UserController {
	...
	public ResponseDTO deleteUserInfo(@PathVariable String userId, Authentication authentication) {
		Long id = Long.parseLong(userId);
		ResponseDTO response = userService.removeUser(id, authentication);
		return response;
	}
}
